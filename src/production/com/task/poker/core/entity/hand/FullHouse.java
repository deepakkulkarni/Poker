...
public final class FullHouse extends PokerHand {
    ...
    public FullHouse(final List<Card> cards) {
    ...
    private void setCardRankOrder(final EvaluationResult evaluationResult, final List<Card> pair, final List<Card> triplet) {
